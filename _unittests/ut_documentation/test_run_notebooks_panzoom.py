...
class TestRunNotebooksPythonPanZoom(unittest.TestCase):
    ...
    def test_run_notebook(self):
        ...
        temp = get_temp_folder(__file__, "temp_run_notebooks_panzoom")

        fnb = os.path.normpath(os.path.join(
            os.path.abspath(os.path.dirname(__file__)), "..", "..", "_doc", "notebooks"))
        keepnote = []
        for f in os.listdir(fnb):
            if os.path.splitext(f)[-1] == ".ipynb" and "panzoom" in f:
